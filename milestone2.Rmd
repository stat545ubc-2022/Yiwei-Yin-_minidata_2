...
1.  *Among different property type, do The apartments with visitor parking in general has more number of accessible parking?*
2.  *Among different property type, do the apartments with more units tend to have more storeys*
...
<!--------------------------- Start your work below --------------------------->
There may be certain relationship that exists for having visitor parking and the number of accessible parking as well as the number of units and storeys. However, property type may change this relationship. This relationship is important for urban planning. 
<!----------------------------------------------------------------------------->
...
<!--------------------------- Start your work below --------------------------->
```{r}
apt_buildinganalysis<-apt_buildings%>%
  select(id,property_type,visitor_parking,no_of_accessible_parking_spaces,no_of_units,no_of_storeys)
apt_buildinganalysis
