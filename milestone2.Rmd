...
apt_buildingnew<-apt_buildings %>% 
  select(id,heating_type,no_of_units,no_of_storeys,year_built,cooling_room,ward,no_of_storeys)
head(apt_buildingnew)
```
I select 8 variables which are id,heating_type, no_of_units, no_of_storeys, year_built, cooling_room, ward, no_of_storeys. The data is tidy, because each row is an observation, each column is a variable, and each cell is a value. 
<!----------------------------------------------------------------------------->
...
apt_building_untidy<-apt_buildingnew %>%
  pivot_wider(names_from = heating_type,values_from = year_built)
